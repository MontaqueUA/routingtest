...
nacho_routing = User_Organization.new(user: nacho, organization: routing, active: true)
ignacio_pricing = User_Organization.new(user: ignacio, organization: pricing, active: true)
nacho_pricing = User_Organization.new(user: nacho, organization: pricing, active: false)

r1 = routing.routes.create(
	starts_at: DateTime.new(2022,19,1,9,00,0), 
	ends_at: DateTime.new(2022,19,1,11,30,0), 
	travel_time: 60, 
	total_stops: 4, 
	action: "pickup",
	driver: diego,
...
r2 = routing.routes.create(
	starts_at: DateTime.new(2022,19,1,9,00,0), 
	ends_at: DateTime.new(2022,19,1,10,10,0), 
	travel_time: 60, 
	total_stops: 4, 
	action: "pickup")
r3 = routing.routes.create(
	starts_at: DateTime.new(2022,19,1,11,00,0), 
	ends_at: DateTime.new(2022,19,1,13,30,0), 
	travel_time: 60, 
	total_stops: 4, 
	action: "pickup")